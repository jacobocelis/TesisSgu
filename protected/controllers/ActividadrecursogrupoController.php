...
class ActividadrecursogrupoController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Actividadrecursogrupo');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['Actividadrecursogrupo']))
			$model->attributes=$_GET['Actividadrecursogrupo'];
	 ...
	 * @param Actividadrecursogrupo $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='actividadrecursogrupo-form')
		{
