...
class MetasController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','establecer'),
				'users'=>array('*'),
			),
	...
	public function actionEstablecer($id){
		$model=$this->loadModel($id);
		...
		if(isset($_POST['Metas'])){
			...
			if (Yii::app()->request->isAjaxRequest){
				echo CJSON::encode(array(
					'status'=>'failure', 
					'div'=>$this->renderPartial('_form', array('model'=>$model,'tipo'=>$_POST["tipo"]), true)));
				exit;               
			}
	 ...
	 * @param Metas $model the model to be validated
	 */
