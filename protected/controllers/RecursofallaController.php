...
class RecursofallaController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Recursofalla');
	...
	{
		$model=new Recursofalla('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Recursofalla']))
			$model->attributes=$_GET['Recursofalla'];
	 ...
	 * @return Recursofalla the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Recursofalla::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Recursofalla $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='recursofalla-form')
		{
