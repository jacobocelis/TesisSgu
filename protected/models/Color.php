...
/**
 * This is the model class for table "sgu_color".
 *
 * The followings are the available columns in table 'sgu_color':
 * @property integer $id
...
class Color extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'sguVehiculos' => array(self::HAS_MANY, 'Vehiculo', 'idcolor'),
		);
	}
