...
/**
 * This is the model class for table "sgu_informacion".
 *
 * The followings are the available columns in table 'sgu_informacion':
 * @property integer $id
...
class Informacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, informacion, descripcion, idvehiculo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'sguGrupoitems' => array(self::HAS_MANY, 'SguGrupoitem', 'idinformacion'),
			'idvehiculo0' => array(self::BELONGS_TO, 'SguVehiculo', 'idvehiculo'),
			'sguVehiculoitems' => array(self::HAS_MANY, 'SguVehiculoitem', 'idinformacion'),
		);
	}
	/**
