...
/**
 * This is the model class for table "sgu_kilometraje".
 *
 * The followings are the available columns in table 'sgu_kilometraje':
 * @property integer $id
 * @property string $fecha
 * @property double $lectura
 * @property integer $idvehiculo
 *
 * The followings are the available model relations:
 * @property SguVehiculo $idvehiculo0
 */
class Kilometraje extends CActiveRecord
{
	/**
	 ...
	 * @return Kilometraje the static model class
	 */
