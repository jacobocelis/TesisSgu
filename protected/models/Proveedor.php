...
/**
 * This is the model class for table "sgu_proveedor".
 *
 * The followings are the available columns in table 'sgu_proveedor':
 * @property integer $id
...
class Proveedor extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, nombre, RIF, direccion, telefono', 'safe', 'on'=>'search'),
		);
	}
