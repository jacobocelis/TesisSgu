...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'idactividadMtto',CHtml::listData(Actividadmtto::model()->findAll(),'id','actividad'),array('id'=>'actividad','style' => 'width:378px;')); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'idtiempod',CHtml::listData(Tiempo::model()->findAll(array("condition"=>"id = 2 or id = 5 or id = 1 order by id DESC")),'id','tiempo'),array('style' => 'width:110px;')); ?>
