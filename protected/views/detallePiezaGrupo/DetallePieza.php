...
<div class='crugepanel user-assignments-role-list'>
	<h1><?php echo ucfirst(CrugeTranslator::t("Detalle de cada repuesto en grupo de vehiculos"));?></h1>
	<p><?php echo ucfirst(CrugeTranslator::t("Haz click en un grupo para ver y agregar un detalle general a cada pieza"));?></p>
...
function agregar(){
  ...
  window.open('',"Agregar","alwaysRaised=yes,toolbar=no,menubar=no,status=no,resizable=yes,width=600,height=500,left=50,top=100");
}
