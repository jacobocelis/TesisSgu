...
<div class="row">
	...
	<?php echo $form->labelEx($model,'idvehiculo',array('style' =>'width:80px;')); ?>
		<?php echo $form->dropDownList($model,'idvehiculo',CHtml::listData(Vehiculo::model()->findAll('activo =1'),'id','numeroUnidad'),array('prompt'=>'Seleccione: ','style' => 'width:120px;','onchange'=>'obtenerConductor(this.value);')); ?>
