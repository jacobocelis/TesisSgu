...
$this->menu=array(
	...
	array('label'=>'      Órdenes listas para cerrar <span id="listas" class="badge badge-'.$Colorli.' pull-right">'.$listas.'</span>', 'url'=>array('mttoCorrectivo/cerrarOrdenes'), 'visible'=>Yii::app()->user->checkAccess('action_mttocorrectivo_cerrarordenes')),
