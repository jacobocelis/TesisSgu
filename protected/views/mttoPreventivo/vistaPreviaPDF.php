...
$this->widget('zii.widgets.grid.CGridView', array(
				...
				array(
					...
					'header'=>'Vehiculo',
					'value'=>'\'<strong>Unidad: </strong> #\'.str_pad((int) $data->numeroUnidad,2,"0",STR_PAD_LEFT).\' \'.$data->idmodelo0->idmarca0->marca.\'  \'.$data->idmodelo0->modelo.\' \'.$data->anno.\' \'.$data->idcolor0->color',
