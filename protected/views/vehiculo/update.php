...
$this->menu=array(
	...
	array('label'=>'Desincorporar vehiculo', 'url'=>array('vehiculo/desincorporar', 'id'=>$model->id) ,'linkOptions'=>array('style'=>'cursor:pointer;cursor:pointer;background:#FFE0E1;')),
