...
$this->breadcrumbs=array(
	...
	'Partes'=>array('vehiculo/'.$id['idvehiculo']),
	'Detalle'=>array('vehiculo/DetallePieza/'.$id['idvehiculo']),
	$id['idvehiculo'],
);
	$this->menu=array(
...
<div class="derecha"><?php echo CHtml::button('Atrás',array('submit' =>array('vehiculo/DetallePieza/'.$id['idvehiculo'])),array('style'=>'text-align:right;')); ?></div>
</div>
</div>
<style type="text/css">
.derecha {
